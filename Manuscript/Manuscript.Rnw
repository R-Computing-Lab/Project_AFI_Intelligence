...
file_drive= "C:"
##file_drive="E:"
directory = paste0(file_drive,"/Dropbox/Work/Research/Projects/Legacy/NLSY/AFI")
#
# Functions
...
capture.output(xtable(cor_1star(matrix_afi_cousincor,2,NA,include.n=TRUE)),file=paste0(directory,"/Common/content/tables/table_sibafig2_z.tex"))
...
capture.output(xtable(cor_1star(A,2,.01,include.n=TRUE)),file=paste0(directory,"/Common/content/tables/table_ttintreliable_z.tex"))
